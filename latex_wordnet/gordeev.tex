...
Using information from another language which is not related to any test languages is helpful. SIF provides a boost of ~3.5 F1-score points compared to simple TF-IDF averaging.
\begin{table*}[!htb]
	\small
